<template>
  <div class="about">
    <div id="write" class="is-node">
      <h1>
        <a name="关于" class="md-header-anchor"></a>
        <span>关于</span>
      </h1>
      <div class="about-me">
        <p>
          <span>关于我：一个不知名大学的全日制在校生，16届，2020年毕业，现大四。</span>
        </p>
        <p>
          <span></span>
          <span>此项目纯属一个灵感突现，加上刚学完Vue.js和Bootstrap的响应式布局，就用豆瓣的电影排行榜数据接口完成了本项目，中间断断续续了几天，最后还是勉强完成，我对网页布局的设计感不强， 所以还没办法写出比较炫酷的网页，此项目纯属练手，在下面会展示本项目用到的豆瓣接口。</span>
        </p>
      </div>
      <p>&nbsp;</p>
      <h2>
        <a name="分类排行榜api" class="md-header-anchor"></a>
        <span>分类排行榜api</span>
      </h2>
      <ul>
        <li>
          <span>接口地址：</span>
          <code>https://movie.douban.com/j/chart/top_list?type=11&amp;interval_id=100%3A90&amp;action=&amp;start=0&amp;limit=20</code>
        </li>
        <li>
          <span>type对应的就是各个分类；</span>
        </li>
      </ul>
      <p>
        <span></span>
...
#typora-quick-open-item {
  ...
  border-color: rgb(254, 254, 254) rgb(229, 229, 229) rgb(229, 229, 229)
    rgb(238, 238, 238);
  border-style: solid;
  border-width: 1px;
}
